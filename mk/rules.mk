...
# Rule to create a library file
$(OUTPUT_BINARY_DIRECTORY)/$(OUTPUT_FILENAME).a: $(BUILD_DIRECTORIES) $(OBJECTS)
	@echo Creating library $(OUTPUT_FILENAME).a 
	$(NO_ECHO)$(AR) $(OUTPUT_BINARY_DIRECTORY)/$(OUTPUT_FILENAME).a $(OBJECTS)
	@echo Done
